 ...
 * @Audit\Auditable()
 */
#[ORM\Entity(repositoryClass: \App\Locodio\Infrastructure\Database\AssociationRepository::class)]
class Association
{
    // ———————————————————————————————————————————————————————————————————————————————————————
    // Properties
    ...
    #[ORM\ManyToOne(targetEntity: "App\Locodio\Domain\Model\Model\DomainModel", fetch: "EXTRA_LAZY", inversedBy: "associations")]
    ...
    {
        return AssociationType::from($this->typeField);
    }
