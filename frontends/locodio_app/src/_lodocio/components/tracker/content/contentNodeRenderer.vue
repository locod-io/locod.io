  ...
  <div :id="'content-node-'+nodeRef.uuid"
    ...
    <div class="flex gap-2 font-bold p-2">
      ...
      <div class="flex-none p-1">
        <tracker-status-badge :node="nodeRef" v-on:clicked="closeAllEditors"/>
      </div>
...
import TrackerStatusBadge from "@/_lodocio/components/tracker/content/trackerStatusBadge.vue";
