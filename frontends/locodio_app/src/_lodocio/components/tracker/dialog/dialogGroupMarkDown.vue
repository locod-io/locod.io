...
import type {TrackerNodeGroup, TrackerNode} from "@/_lodocio/api/interface/tracker";
...
function _convertNodeToMarkDown(_node: TrackerNode): void {
  markdown.value = markdown.value + "" + convertNodeToMarkDown(_node);
}

function _convertGroupToMarkDown(_group: TrackerNodeGroup): void {
