...
import type {relatedProjectDocument} from "@/_lodocio/api/interface/wiki";
import DeleteButton from "@/components/common/deleteButton.vue";
import {addProjectDocument} from "@/_lodocio/api/command/wiki/addProjectDocument";
import {useToast} from "primevue/usetoast";
import {deleteProjectDocument} from "@/_lodocio/api/command/wiki/deleteProjectDocument";

const props = defineProps<{
  type: 'wiki' | 'group' | 'node',
  id: number,
  markdown: string,
