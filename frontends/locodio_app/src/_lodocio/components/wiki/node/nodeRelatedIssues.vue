...
<template>
  ...
  <TabView>
    <TabPanel v-for="issue in wikiStore.wikiNodeRelatedIssues.collection"
              :key="issue.id">
      <template #header>
        <div>
...
import type {ChangeNodeRelatedIssuesCommand} from "@/_lodocio/api/command/wiki/changeNodeRelatedIssues";
import {changeNodeRelatedIssues} from "@/_lodocio/api/command/wiki/changeNodeRelatedIssues";
...
const selectedIssues = ref(wikiStore.wikiNode?.relatedIssues);
